...
?>
        ...
        <div class="row">
            ...
            <div class="col-md-10 columns">
                ...
                <span style="display:inline-block; width:100%; margin-top: 20px; width: 90%;">
                <a style="float:left" title="Open a link to the Teams interface" href="<?php echo $config['app']['teams_link']; ?>" target="_blank">Connect in Teams</a>
                <a title="Open the training video in a new window" href="<?php echo $config['app']['video_link']; ?>" target="_blank">Training Video</a>
                <a style="float:right" title="Open a new window to submit feedback" href="<?php echo $config['app']['feedback_link']; ?>" target="_blank">Submit Feedback</a>
                </span>
                    </p>
<?php
